...
| `health/mealPlannerPatterns.ts` + `mealPlanningAgent.ts` | Day/week meal planning journey when message matches planner patterns | Health | Nutrition | **Meal planner** | none |
