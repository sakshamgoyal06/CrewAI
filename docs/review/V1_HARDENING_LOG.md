...
| 2026-09-12 | (pending) | agent | lists + notion + logging CRUD | B partial | Notion unparked in minimal mode; `notion_list_sync` job; `delete_list_item`; `get_daily_log`; `add_goal` in minimal allowlist |
