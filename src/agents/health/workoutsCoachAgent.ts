...
/**
 * Workouts department entry — thin wrapper around the existing Fitness specialist flow
 * (`tryFitnessAgent` in `fitnessAgent.ts`) so architecture can name the Workouts coach explicitly.
 *
