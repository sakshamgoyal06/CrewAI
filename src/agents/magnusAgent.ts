  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        morning_intention: {
          type: "string",
          description: "One-line intention for the day (morning orientation).",
        },
        energy_level: {
          type: "number",
          description: "Energy 1–5 from morning check-in.",
        },
        week_priorities: {
          type: "string",
          description: "Monday week priorities (numbered or comma-separated).",
        },
        weekly_win: { type: "string", description: "Friday wrap — one win from the week." },
        weekly_slip: { type: "string", description: "Friday wrap — what slipped." },
    ...
    switch (name) {
      ...
      case "log_daily_checkin":
        return await logDailyCheckin({
          ...
          morning_intention: str(input.morning_intention),
          energy_level: num(input.energy_level),
          week_priorities: str(input.week_priorities),
          weekly_win: str(input.weekly_win),
          weekly_slip: str(input.weekly_slip),
