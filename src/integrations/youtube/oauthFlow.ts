...
export function youtubeOauthLinkAvailable(): boolean {
  return platformGoogleOAuthReady() && Boolean(youtubeOauthRedirectUri());
}
...
/**
 * Exchange the Google code, store google_youtube_refresh_token for the user in the state payload.
 */
