...
export async function manageProactiveMessages(input: {
  ...
  return [
    ...
    "Kinds: evening_journal, week_planning, weekly_wrap, monthly_goal_review, drift_guard, midday_encouragement, stale_list_nudge, chat_inactivity (catalog); custom_reminder (one-shot or daily).",
  ].join("\n");
}
