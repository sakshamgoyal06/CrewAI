  ...
  if (action === "list") {
    ...
    if (subs.length === 0) {
      return [
        ...
        "Catalog kinds (opt in with enable): evening_journal, drift_guard, midday_encouragement, stale_list_nudge, chat_inactivity, meal_log_reminder, meal_adherence_nudge, meal_eod_reconciliation, meal_gap_nudge, weekly_nutrition_review.",
